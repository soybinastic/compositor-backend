...
RECORDING_VIDEO_BITRATE = int(os.getenv('RECORDING_VIDEO_BITRATE', '8000000'))
RECORDING_AUDIO_BITRATE = int(os.getenv('RECORDING_AUDIO_BITRATE', '192000'))
...
STREAMING_VIDEO_BITRATE = int(os.getenv('STREAMING_VIDEO_BITRATE', '4500000'))
STREAMING_AUDIO_BITRATE = int(os.getenv('STREAMING_AUDIO_BITRATE', '192000'))
...
STREAMING_MAX_DESTINATIONS = int(os.getenv('STREAMING_MAX_DESTINATIONS', '10'))
